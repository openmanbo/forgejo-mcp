...
export const TOOLS: Tool[] = [
  ...
  },
  {
    name: "get_git_token",
    description:
      "Get the git access token and the Forgejo server URL configured for this MCP server. " +
  ...
  // -------------------------------------------------------------------------
  {
    ...
    description:
      "List pull requests in a repository. Uses GET /api/v1/repos/{owner}/{repo}/pulls.",
    inputSchema: {
      type: "object",
      required: ["owner", "repo"],
      properties: {
  ...
  },
  {
    ...
    description:
      "Get details of a specific pull request. Uses GET /api/v1/repos/{owner}/{repo}/pulls/{index}.",
    inputSchema: {
      type: "object",
      required: ["owner", "repo", "index"],
      properties: {
  ...
  },
  {
    ...
    description:
      "Create a new pull request. Uses POST /api/v1/repos/{owner}/{repo}/pulls.",
    inputSchema: {
      type: "object",
  ...
  },
  {
    ...
    description:
      "Merge a pull request. Uses POST /api/v1/repos/{owner}/{repo}/pulls/{index}/merge.",
    inputSchema: {
      type: "object",
  ...
  },
  {
    ...
    description:
      "Update a pull request branch with the base branch (rebase or merge). " +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        style: {
          ...
          enum: ["rebase", "merge"],
          description:
            "How to update the branch: 'rebase' or 'merge'. Default: merge.",
        },
      },
    },
  },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    description:
      "Create/submit a review on a pull request. You can approve, request changes, " +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        event: {
          ...
          description:
            "Review event type: APPROVED, REQUEST_CHANGES, COMMENT, or PENDING.",
        },
        body: {
          type: "string",
        ...
        commit_id: {
          type: "string",
          description:
            "SHA of the commit to review. Defaults to the latest commit if omitted.",
        },
        comments: {
          type: "array",
  ...
  },
  {
    ...
    description:
      "Delete a review on a pull request. " +
  ...
  },
  {
    ...
    description:
      "List comments of a specific review on a pull request. " +
